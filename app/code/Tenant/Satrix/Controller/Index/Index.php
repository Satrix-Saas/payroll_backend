...
*/
const XML_PATH_EMAIL_RECIPIENT = 'base/email/custumemail';
/**
...
public function execute()
{
    ...
    try {
        ...
        $sender = [
            'name' => $this->_escaper->escapeHtml('labham'),
            'email' => $this->_escaper->escapeHtml('rishbahvishwakrma6394@gamil.com'),
        ];

        $storeScope = \Magento\Store\Model\ScopeInterface::SCOPE_STORE; 
        $transport = $this->_transportBuilder
            ->setTemplateIdentifier('custom_email_template') // this code we have mentioned in the email_templates.xml
            ->setTemplateOptions(
                [
